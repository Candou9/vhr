...
import org.jx.vhr.entity.Nation;
...
public interface NationMapper {
     ...
     *
     * @param entities List<Nation> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<Nation> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<Nation> entities);
