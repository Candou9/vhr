...
import org.jx.vhr.entity.Oplog;
...
public interface OplogDao {
     ...
     *
     * @param entities List<Oplog> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<Oplog> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<Oplog> entities);
